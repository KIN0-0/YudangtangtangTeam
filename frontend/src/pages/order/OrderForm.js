        ...
        <Container>
            <Contents>
                ...
                <OrderArea>
                                ...
                                return (
                                    <tbody style={{ textalign: "center" }}>
                                        <tr style={{ display: "table-row", verticalalign: "inherit", bordercolor: "inherit", border: "1" }}>
                                            ...
                                            <InfoTd2 style={{
                                                paddingright: "10px", borderRight: "1px solid #ebebeb",
                    ...
                    <OrderFormArea>
                        <OrderFormAreaTitle><OrderAreaTitleContents>주문 정보</OrderAreaTitleContents></OrderFormAreaTitle>
                        <OrderFormArea>
                            <OrderTable>
                                <colgroup>
                                    <col style={{ width: "139px" }}></col>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <Tabletd>
                                            <OrderInput style={{ width: "180px" }}
                                                name="userTel" defaultValue={buyerTel}></OrderInput>
                                        </Tabletd>
                                    </tr>
                                </tbody>
                            </OrderTable>
                            ...
                            <OrderTable>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <Tabletd>
                                            <OrderInput className="user_enroll_text" type="text"
                                                id="joinrTel2" name="recipAddress" minlength="11" maxlength="11" onChange={handleInput2} value={enroll_company2.address} style={{ width: "280px" }}></OrderInput>
                                            <AdressButton type="button" onClick={handleComplete2}>주소검색</AdressButton><br></br>
                                            ...
                                            {popup2 && <Post2 company={enroll_company2} setcompany2={setEnroll_company2}></Post2 >}
                                        </Tabletd>
                                    </tr>
                                    <tr>
                                        <Tableth>전화번호</Tableth>
